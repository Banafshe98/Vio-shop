...
export const checkVariant = (variant: TVariant) => {
  switch (variant) {
    case "primary":
      return "text-white bg-green-400 rounded px-10 py-4";
    case "secondary":
      return "text-gray-700 bg-gray-200 rounded px-10 py-4";
    case "success":
      return "text-white bg-green-600 rounded px-10 py-4";
    case "warning":
      return "text-white bg-yellow-500 rounded px-10 py-4";
    case "danger":
      return "text-white bg-red-600 rounded px-10 py-4";
    default:
      return ""; // Fallback in case of an unknown variant
  }
};